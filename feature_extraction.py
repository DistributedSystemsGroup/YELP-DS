...
class Histogram():
    def run(self, filename):
        ...
        with open("data/dictionary/mydictionary_3bins.json") as dicObject3Bins, open("data/dictionary/mydictionary_6bins.json") as dicObject6Bins, open("data/dictionary/mydictionary_2bins.json") as dicObject2Bins, open(filename) as fileObject:    
