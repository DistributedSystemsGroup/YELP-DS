        ...
        for i in xrange (1, 40):
            ...
            if kernel == "poly":
                for deg in xrange(1, 10): 
                    degree = deg
                    Scikit_SVM_Model = svm.SVC(C=C, kernel=kernel, degree=degree, gamma=0.0, coef0=0.0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False, max_iter=-1, random_state=None)
            else:
            ...
            additional_info = 'Kernel=' + str(ker) + ", C=" + str(C) + '\n'
