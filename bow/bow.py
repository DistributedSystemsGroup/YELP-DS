...
with open('../data/input/1000samples.json') as fileobject, open("../data/dictionary/mydictionary_2bins.json") as dicObject2Bins, open("../data/dictionary/mydictionary_3bins.json") as dicObject3Bins, open("../data/dictionary/mydictionary_6bins.json") as dicObject6Bins:
